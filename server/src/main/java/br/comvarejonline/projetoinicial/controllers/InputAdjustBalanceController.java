...
import br.comvarejonline.projetoinicial.services.InputAdjustBalanceService;
...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("/input-adjust-movements")
public class InputAdjustBalanceController {

    @Autowired
    private InputAdjustBalanceService service;

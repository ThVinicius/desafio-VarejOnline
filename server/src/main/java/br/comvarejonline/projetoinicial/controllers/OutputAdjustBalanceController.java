...
import br.comvarejonline.projetoinicial.services.OutputAdjustBalanceService;
...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("/output-adjust-movements")
public class OutputAdjustBalanceController {

    @Autowired
    private OutputAdjustBalanceService service;
